			...
			<Dialog>
				...
				<DialogContent className='sm:max-w-[425px]'>
					...
					<div className='flex flex-col gap-4 py-4'>
						<Button
							className='w-full flex items-center gap-2 bg-white text-black border hover:bg-gray-100 hover:text-black'
						...
						<Button
							className='w-full flex items-center gap-2 bg-[#24292e] hover:bg-[#2c3238] text-white'
